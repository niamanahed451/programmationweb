...
<head>
  ...
  <!-- naigateur va lire qlq chose responsive , page avec beug    -->
...
xmlhttp.send();
          ...
          <div class="col-xl-7 ">
            <div class="row">
              ...
              <div class="row">
                <div class="col"><img src="img/money.jpg"  style = "width: 50px; height: 50px; " class="img-fluid" alt="Responsive image"></div>
                <div class="col"></div>
                <div class="col"><?php print_r ($a[7]); ?>  </div>
              </div>
              <div class="row">
                <div class="col"><img src="img/co2.jpg"  style = "width: 50px; height: 50px; " class="img-fluid" alt="Responsive image"></div>
                <div class="col"></div>
                ...
                <div class="col">
                    ...
                    <div class="card">
                      ...
                      <div class="row">
                        ...
                        <div class="col"><img src="img/soleil.jpg"  style = "width: 50px; height: 50px; " class="img-fluid" alt="Responsive image"></div>
          ...
          <div class="row">
            <div class="col-8"> <canvas id="myChart2"></canvas></div>
            <div class="col-4">
            <br>
            <br>
                Injection réseau <br>
...
obj = { "limit":10 };
dbParam = JSON.stringify(obj);
//conexionserveur alarmshart.php
xmlhttp = new XMLHttpRequest();
xmlhttp.onreadystatechange = function() {
  if (this.readyState == 4 && this.status == 200) {
  //  document.getElementById("demo").innerHTML = this.responseText;
